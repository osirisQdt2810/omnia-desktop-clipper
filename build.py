...
def build_args(icon: Path | None = None) -> list[str]:
    ...
    if sys.platform.startswith("win"):
        # The wrapper itself is generated by the CALLER before the freeze (build_args only
        # builds a list); see _generate_comtypes_uia_wrapper.
...
def main() -> int:
    ...
    if sys.platform.startswith("win"):
        # Before the freeze, not inside build_args: it has a side effect (it writes a generated
        # module into comtypes/gen/) and an argument-list builder must not.
